  ...
  return (
    <WagmiProvider config={config}>
      <QueryClientProvider client={queryClient}>
        <RainbowKitProvider>
          <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-black flex flex-col items-center justify-center p-6 text-white gap-10">
            ...
            <p className="absolute bottom-6 text-xs opacity-50">
              Минт работает прямо в Warpcast
            </p>
          </div>
        </RainbowKitProvider>
      </QueryClientProvider>
